...
### **● 最新バージョン**(v1.4.4)
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_form_futaba_kai/releases/download/v1.4.4/koshian_form_futaba_kai-1.4.4-fx.xpi)  
